        ...
        <div class="panel">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h5 id="panel-header-text-small">Front-End Development</h5>
 ...
 <div class="container">
		<div class="row">
			<div class="[ col-xs-12 col-sm-offset-2 col-sm-12 ]">
				<ul class="event-list">
                    <li onclick="window.open('https://www.udemy.com/web-developer-course/')">
						<time>
							<span class="hours">31.5</span>
					...
					<li onclick="window.open('https://www.lynda.com/learning-paths/Web/become-a-front-end-web-developer')">
						<time>
							<span class="hours">37</span>
							<span class="hours-txt">Hours</span>
                            <hr class="courses-line">
...
<li onclick="window.open('https://www.udacity.com/course/front-end-web-developer-nanodegree--nd001')">
						<time>
							<span class="hours">288</span>
							<span class="hours-txt">Hours</span>
                            <hr class="courses-line">
