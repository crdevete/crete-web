				...
				<ul class="event-list">
                    <li onclick="window.open('https://www.udemy.com/the-complete-web-developer-course-2')">
						...
						<div class="info">
							...
							<br>
							<div class="row">
								<div class="col-sm-12 course-description">Learn Web Development by building 25 websites and mobile apps using HTML, CSS, Javascript, PHP, Python, MySQL & more!
</div>
						...
						<div class="info">
							...
							<br>
							<div class="row">
								<div class="col-sm-12 course-description">Get the skills to work with both back-end and front-end technologies as a full-stack developer. You'll develop a solid foundation for working with servers and host configurations, performing database integrations, and troubleshooting front-end development issues.
</div>
						...
						<div class="info">
							...
							<br>
							<div class="row">
								<div class="col-sm-12 course-description">This program will prepare you for a job as a Full Stack Web Developer, and teach you to build complex server-side web applications that use powerful relational databases to persistently store data.
