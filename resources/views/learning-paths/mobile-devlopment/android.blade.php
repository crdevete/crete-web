        ...
        <div class="panel">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <h5 id="panel-header-text-small">Android Devlopment</h5>
 ...
 <div class="container">
		<div class="row">
			<div class="[ col-xs-12 col-sm-offset-2 col-sm-12 ]">
				<ul class="event-list">
                    <li onclick="window.open('https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801')">
						<time>
                        ...
                        <div class="row">
                                          ...
                                          <li onclick="window.open('https://www.udemy.com/design-code-an-android-app-from-scratch')">
						<time>
							<span class="hours">16.5</span>
							<span class="hours-txt">Hours</span>
                            <hr class="courses-line">
							<span class="hours-txt"><i class="fa fa-star" aria-hidden="true"></i></span>
                            <span class="level">Beginner</span>
